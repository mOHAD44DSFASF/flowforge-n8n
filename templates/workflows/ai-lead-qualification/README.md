...
| :--- | :--- | :--- | :--- |
| **AI Lead Webhook** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **GPT Lead Score Check** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Is Score > 7?** | `n8n-nodes-base.if` | v1 | Conditional routing element |
| **Sales Slack Alert** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Low Priority Archive** | `n8n-nodes-base.set` | v1 | Processing element |
| **AI Respond** | `n8n-nodes-base.respondToWebhook` | v1 | Processing element |
...
*   **Reliability warning:** HTTP Request node `GPT Lead Score Check` has no retry or error handling option configured.
*   **Reliability warning:** HTTP Request node `Sales Slack Alert` has no retry or error handling option configured.
