...
| :--- | :--- | :--- | :--- |
| **Daily Trigger** | `n8n-nodes-base.scheduleTrigger` | v1 | Trigger event handler |
| **Main DB backup task** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Did Task Fail?** | `n8n-nodes-base.if` | v1 | Conditional routing element |
| **Slack Alert Failure** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
...
*   **Reliability warning:** HTTP Request node `Slack Alert Failure` has no retry or error handling option configured.
