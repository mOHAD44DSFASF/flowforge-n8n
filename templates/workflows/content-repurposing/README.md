...
| :--- | :--- | :--- | :--- |
| **Raw Content hook** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **AI Repurpose Content** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Split Outputs** | `n8n-nodes-base.code` | v1 | Code block execution |
| **Airtable Queue Posts** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
...
*   **Reliability warning:** HTTP Request node `AI Repurpose Content` has no retry or error handling option configured.
*   **Reliability warning:** HTTP Request node `Airtable Queue Posts` has no retry or error handling option configured.
