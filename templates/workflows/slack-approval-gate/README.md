...
| :--- | :--- | :--- | :--- |
| **Trigger Deploy** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **Slack Approval Block** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Deploy Respond OK** | `n8n-nodes-base.respondToWebhook` | v1 | Processing element |
...
*   **Reliability warning:** HTTP Request node `Slack Approval Block` has no retry or error handling option configured.
