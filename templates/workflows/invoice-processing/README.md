...
| :--- | :--- | :--- | :--- |
| **Invoice Webhook** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **Parse Invoice OCR** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Validate totals** | `n8n-nodes-base.if` | v1 | Conditional routing element |
| **Insert DB Record** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Invoice respond** | `n8n-nodes-base.respondToWebhook` | v1 | Processing element |
...
*   **Reliability warning:** HTTP Request node `Parse Invoice OCR` has no retry or error handling option configured.
*   **Reliability warning:** HTTP Request node `Insert DB Record` has no retry or error handling option configured.
