...
| :--- | :--- | :--- | :--- |
| **Poll RSS Interval** | `n8n-nodes-base.scheduleTrigger` | v1 | Trigger event handler |
| **Fetch Feed HTTP** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Filter new items** | `n8n-nodes-base.code` | v1 | Code block execution |
| **Queue Social Post** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
...
*   **Reliability warning:** HTTP Request node `Fetch Feed HTTP` has no retry or error handling option configured.
*   **Reliability warning:** HTTP Request node `Queue Social Post` has no retry or error handling option configured.
