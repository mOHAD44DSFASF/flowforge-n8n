...
| :--- | :--- | :--- | :--- |
| **Catch All Webhook** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **Switch route** | `n8n-nodes-base.switch` | v1 | Processing element |
| **Route A handler** | `n8n-nodes-base.set` | v1 | Processing element |
| **Route B handler** | `n8n-nodes-base.set` | v1 | Processing element |
| **Router respond** | `n8n-nodes-base.respondToWebhook` | v1 | Processing element |
