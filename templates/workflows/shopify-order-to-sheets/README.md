...
| :--- | :--- | :--- | :--- |
| **Shopify Webhook** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **Extract Order properties** | `n8n-nodes-base.set` | v1 | Processing element |
| **Append Sheet Row** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Email alert** | `n8n-nodes-base.gmail` | v1 | Outbound email notification |
| **Shopify OK** | `n8n-nodes-base.respondToWebhook` | v1 | Processing element |
...
*   **Reliability warning:** HTTP Request node `Append Sheet Row` has no retry or error handling option configured.
