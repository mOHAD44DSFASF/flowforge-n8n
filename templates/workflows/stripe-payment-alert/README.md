...
| :--- | :--- | :--- | :--- |
| **Stripe Webhook** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **Check is charge** | `n8n-nodes-base.if` | v1 | Conditional routing element |
| **Slack Alert** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Stripe response** | `n8n-nodes-base.respondToWebhook` | v1 | Processing element |
...
*   **Reliability warning:** HTTP Request node `Slack Alert` has no retry or error handling option configured.
