...
| :--- | :--- | :--- | :--- |
| **Notify webhook** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **Format telegram message** | `n8n-nodes-base.set` | v1 | Processing element |
| **Send Telegram API** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Telegram respond** | `n8n-nodes-base.respondToWebhook` | v1 | Processing element |
...
*   **Reliability warning:** HTTP Request node `Send Telegram API` has no retry or error handling option configured.
