...
| :--- | :--- | :--- | :--- |
| **Monday Morning Trigger** | `n8n-nodes-base.scheduleTrigger` | v1 | Trigger event handler |
| **Fetch Stripe Metrics** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Compile HTML report** | `n8n-nodes-base.code` | v1 | Code block execution |
| **Send report email** | `n8n-nodes-base.gmail` | v1 | Outbound email notification |
...
*   **Reliability warning:** HTTP Request node `Fetch Stripe Metrics` has no retry or error handling option configured.
