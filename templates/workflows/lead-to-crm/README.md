...
| :--- | :--- | :--- | :--- |
| **Lead Webhook** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **Validate fields** | `n8n-nodes-base.set` | v1 | Processing element |
| **Push to CRM** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Slack Notify** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Respond success** | `n8n-nodes-base.respondToWebhook` | v1 | Processing element |
...
*   **Reliability warning:** HTTP Request node `Slack Notify` has no retry or error handling option configured.
