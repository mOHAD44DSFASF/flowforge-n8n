...
| :--- | :--- | :--- | :--- |
| **Enrich Trigger Webhook** | `n8n-nodes-base.webhook` | v1 | Webhook endpoint trigger (POST) |
| **Clearbit Enrichment** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Merge Lead Fields** | `n8n-nodes-base.set` | v1 | Processing element |
| **Update Hubspot CRM** | `n8n-nodes-base.httpRequest` | v3 | Outbound HTTP API integration |
| **Enrich response** | `n8n-nodes-base.respondToWebhook` | v1 | Processing element |
...
*   **Reliability warning:** HTTP Request node `Clearbit Enrichment` has no retry or error handling option configured.
*   **Reliability warning:** HTTP Request node `Update Hubspot CRM` has no retry or error handling option configured.
